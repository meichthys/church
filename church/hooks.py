...
fixtures = [
	...
	# Patch fixtures (processed by church.utils.update_patches)
	{
		"dt": "Form Tour",
		"filters": [["Name", "like", "Church%"]],
		"patch": "after_install",
	...
	{"dt": "About Us Settings", "patch": "after_install"},
	{"dt": "Bible Book", "patch": "after_install"},
	{"dt": "Bible Translation", "patch": "after_install"},
	{
	...
	{
		"dt": "Fund",
		"filters": [["fund", "in", ["Building", "General", "Missions"]]],
		"patch": "after_install",
	},
	{
		"dt": "Member Status",
	...
	},
	{
		...
		"filters": [
			["frequency", "in", ["Weekly", "Bi-Weekly", "Monthly", "Bi-Monthly", "Quarterly", "Yearly"]]
		],
		"patch": "after_install",
	},
	{
	...
	{
		"dt": "Position Type",
		"filters": [["position", "in", ["Deacon", "Elder", "Pastor", "Secretary", "Treasurer"]]],
		"patch": "after_install",
	},
	{
	...
	{"dt": "Website Settings", "patch": "after_install"},
]
# Apps
# ------------------
